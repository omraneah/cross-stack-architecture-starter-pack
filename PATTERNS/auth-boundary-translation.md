...
**Stack:** NestJS (TypeScript) with external authentication provider (e.g., Okta, Auth0, Firebase Auth)
...
import { ProviderSdk } from 'provider-sdk'; // in order.service.ts
...
cognitoSub: string; // in order.entity.ts
